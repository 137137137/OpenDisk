...
/// High-performance disk scanner using low-level Darwin APIs.
///
/// Uses `getattrlistbulk` for efficient directory enumeration and
/// aggressive parallelization for maximum throughput.
